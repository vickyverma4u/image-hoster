...
// Here the name of the table to be created in the database is explicitly mentioned as 'Tags'. Hence
// the table named 'Tags' will be created in the database with all the columns mapped to all the
// attributes in 'Tag' class
@Table(name = "Tags")
public class Tag {
  ...
  // will be created
  // Since the mapping is Many to Many, a new table will be generated containing the two columns
